...
void GraphicsWorld::run()
{
     ...
     Point m(6, 8);
     cout << "The count for the number of point objects is " << m.counter() << endl;
     cout << "ID of the first point m is : " << m.getid() << endl;
     Point n(6, 8);
     cout << "ID of the second point n is : " << n.getid() << endl;
     cout << "The count for the number of point objects after creating 2 objects: " << m.counter() << endl;
     n.setx(9);
